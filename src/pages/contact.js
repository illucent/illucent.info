...
const ContactPage = () => (
  ...
  <div className="flex flex-wrap -mx-3 mb-6">
    <div className="w-full px-3">
      ...
      <textarea name="message" className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3 leading-tight" id="grid-message" placeholder="message"></textarea>
      <p className="text-grey-dark text-xs italic">Make it as long and as You like</p>
    </div>
  </div>
  <div data-netlify-recaptcha></div>
  <button className="flex-no-shrink bg-teal hover:bg-teal-dark border-teal hover:border-teal-dark text-sm border-4 text-white py-1 px-2 rounded" type="submit">
      Submit
    </button>
  </form>
);
